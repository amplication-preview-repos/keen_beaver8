...
import { RawMaterialFindManyArgs } from "../../rawMaterial/base/RawMaterialFindManyArgs";
...
export class SupplierControllerBase {
  ...
  @common.Get("/:id/rawMaterials")
  @ApiNestedQuery(RawMaterialFindManyArgs)
  async findRawMaterials(
    @common.Req() request: Request,
    @common.Param() params: SupplierWhereUniqueInput
  ): Promise<RawMaterial[]> {
    const query = plainToClass(RawMaterialFindManyArgs, request.query);
    const results = await this.service.findRawMaterials(params.id, {
      ...query,
      select: {
        acquiringDate: true,
        batchNumber: true,
  ...
  @common.Post("/:id/rawMaterials")
  async connectRawMaterials(
    @common.Param() params: SupplierWhereUniqueInput,
    @common.Body() body: RawMaterialWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      rawMaterials: {
        connect: body,
  ...
  @common.Patch("/:id/rawMaterials")
  async updateRawMaterials(
    @common.Param() params: SupplierWhereUniqueInput,
    @common.Body() body: RawMaterialWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/rawMaterials")
  async disconnectRawMaterials(
    @common.Param() params: SupplierWhereUniqueInput,
    @common.Body() body: RawMaterialWhereUniqueInput[]
  ): Promise<void> {
    const data = {
